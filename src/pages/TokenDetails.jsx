...
export default function TokenDetails() {
  ...
  if (!currentTenant) return <div className="min-h-screen bg-[var(--color-surface-alt)]"><Navbar /></div>;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[var(--color-surface-alt)]">
      ...
      <main className="flex-1 overflow-y-auto py-10 px-4 w-full">
        <div className="max-w-4xl mx-auto w-full animation-fade-in relative">
          ...
          {loading ? (
            ...
            <div className="glass-panel rounded-3xl p-12 text-center border-[var(--color-error)]/20">
              ...
              <button onClick={() => navigate('/')} className="mt-6 btn-primary w-auto inline-block">Return Home</button>
            </div>
          ) : (
